<template>
    <div>
        <DecorationUpperBar class="mb-4" :logo="NAVIGATION.POKEMON.logo" :game="NAVIGATION.POKEMON.value" />
...
const { sealed, fetchSealedProducts, loading } = useShop(GAMES.POKEMON);
